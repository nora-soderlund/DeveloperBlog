...
-- Dumping structure for table developer_blog.github
CREATE TABLE IF NOT EXISTS `github` (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `reason` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `updated_at` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `subject_title` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `subject_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci,
  `subject_type` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `repository_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `repository_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `repository_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci,
  `repository_owner_avatar` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `repository_full_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_swedish_ci;

-- Dumping data for table developer_blog.github: ~0 rows (approximately)
